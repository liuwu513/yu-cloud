...
import org.yuhan.ziyu.auth.config.security.permission.MySecurityMetadataSource;
...
@Transactional
public class PermissionController extends BaseSecurityController {
    ...
    public Result<Permission> edit(@ModelAttribute Permission permission){
        ...
        setUpdateBaseEntity(permission);
