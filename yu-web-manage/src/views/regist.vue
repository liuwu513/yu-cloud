<template>
  <Row type="flex" justify="center" align="middle" class="regist" @keydown.enter.native="submitRegist">
    ...
    <Row class="header">
      <img src="../assets/oss.png" width="220px" />
      <div class="description">oss 是很不错的Web前后端分离架构开发平台</div>
    </Row>
    ...
    <Row class="foot">
      <Row type="flex" justify="space-around" class="code-row-bg help">
        <a class="item" href="https://github.com/Howell/oss" target="_blank">帮助</a>
        <a class="item" href="https://github.com/Howell/oss" target="_blank">隐私</a>
        <a class="item" href="https://github.com/Howell/oss" target="_blank">条款</a>
      </Row>
      <Row type="flex" justify="center" class="code-row-bg copyright">
        Copyright © 2018-Present <a href="http://Howell.cn" target="_blank" style="margin:0 5px;">Howell</a> 版权所有
      </Row>
    </Row>
    </Col>
  </Row>
